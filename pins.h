...
#define X_STOP_PIN         -1// 16

#define Y_STEP_PIN          5
#define Y_DIR_PIN           6
#define Y_ENABLE_PIN       -1
#define Y_STOP_PIN          -1//67

#define Z_STEP_PIN          62
#define Z_DIR_PIN           63
#define Z_ENABLE_PIN       -1
#define Z_STOP_PIN          -1//59
...
//x axis pins
    ...
    #define Z_MAX_PIN      30
    #define Z_MIN_PIN       17
    //#define Z_STOP_PIN          17  // Use E-STOP for autolevel Z probe
    ...
    #define HEATER_2_PIN    -1
    #if MOTHERBOARD == 5
    #define HEATER_BED_PIN  16    //changed @ rkoeppl 20110410
